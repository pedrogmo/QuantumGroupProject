...
def simulate_normal(simulator, bitstring: str, package_size: int, shots=1, mapping="00") -> list:
    """
    ...
    circs = circuit.build_circuits(bitstring, package_size, mapping=mapping)
